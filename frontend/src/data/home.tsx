...
export const SOCIAL_LINKS = [
  { id: 'github', icon: GithubIcon, url: 'https://github.com/atacan', label: 'GitHub' },
  {
    id: 'linkedin',
    icon: LinkedinIcon,
    url: 'https://linkedin.com/in/atacanyucel',
    label: 'LinkedIn',
  },
...
export const EXPERIENCES_DATA = [
  {
    ...
    date: '2023 - Present',
    description:
      'Leading the AI integration team, architecting scalable backend solutions using Python and FastAPI, and mentoring junior developers.',
    color: 'blue',
  },
  {
    id: 2,
    ...
    date: '2021 - 2023',
    description:
      'Developed high-performance trading APIs, managed PostgreSQL databases, and optimized microservices in a cloud-native environment.',
    color: 'indigo',
  },
  {
    id: 3,
    ...
    date: '2019 - 2021',
    description:
      'Built responsive React frontend applications and Node.js backends for various e-commerce clients.',
    color: 'purple',
  },
];
...
export const ARTICLES_DATA = [
  {
    ...
    description:
      "A deep dive into creating fluid user experiences with the latest features of React 19 and Framer Motion's physics engine.",
    url: '#',
    platform: 'Medium',
    date: 'Oct 12, 2023',
    color: 'blue',
  },
  {
    ...
    description:
      "Learn how to architect and deploy highly scalable microservices using Python's fastest web framework.",
    url: '#',
    platform: 'Dev.to',
    date: 'Aug 05, 2023',
    color: 'indigo',
  },
  {
    ...
    description:
      'Exploring the intersection of artificial intelligence and financial technologies: challenges and opportunities.',
    url: '#',
    platform: 'Medium',
    date: 'Jun 22, 2023',
    color: 'purple',
